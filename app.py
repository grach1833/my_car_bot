...
ADMIN_ID = int(os.environ.get('ADMIN_ID', 526517537))
SELLER_USERNAME = os.environ.get('SELLER_USERNAME', "@senchenkomar")
SELLER_PHONE = os.environ.get('SELLER_PHONE', "+79149692914")
